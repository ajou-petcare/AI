...
image_path = '/home/mlmlab08/dog_skin/Data/image'
json_path = '/home/mlmlab08/dog_skin/Data/label'
...
for img_file, json_file in zip(image_files, json_files):
    ...
    label_file = os.path.join('/home/mlmlab08/dog_skin/Data/yolo-label', os.path.basename(img_file).replace('.jpg', '.txt'))
...
# 이미지와 라벨이 저장된 디렉토리
image_data_dir = '/home/mlmlab08/dogskin/Data/image'
label_data_dir = '/home/mlmlab08/dogskin/Data/yolo-label'
...
os.makedirs("/home/mlmlab08/dogskin/dataset/train/images", exist_ok=True)
os.makedirs("/home/mlmlab08/dogskin/dataset/train/labels", exist_ok=True)
os.makedirs("/home/mlmlab08/dogskin/dataset/val/images", exist_ok=True)
os.makedirs("/home/mlmlab08/dogskin/dataset/val/labels", exist_ok=True)

# 분할된 파일들을 적절한 디렉토리로 복사
for img, label in zip(train_images, train_labels):
    shutil.copy(os.path.join(image_data_dir, img), os.path.join("/home/mlmlab08/dogskin/dataset/train/images", img))
    shutil.copy(os.path.join(label_data_dir, label), os.path.join("/home/mlmlab08/dogskin/dataset/train/labels", label))

for img, label in zip(val_images, val_labels):
    shutil.copy(os.path.join(image_data_dir, img), os.path.join("/home/mlmlab08/dogskin/dataset/val/images", img))
    shutil.copy(os.path.join(label_data_dir, label), os.path.join("/home/mlmlab08/dogskin/dataset/val/labels", label))
...
train_results = model.train(
    data='/home/mlmlab08/dog_skin/yolov5/data/dog_skin_yolo_config.yaml', 
    epochs=2000,
    patience=3,
    mixup=0.1,
    project='yolov5-dog_skin',
    device=0
)
...
# Load the model
model = YOLO('/home/mlmlab08/cateye/yolov5/yolov5-dog-skin/train2/weights/best.pt')
results = model.predict('/home/mlmlab08/dog_skin/Data/image/crop_C0_3e3e92b7-60a5-11ec-8402-0a7404972c70.jpg')
